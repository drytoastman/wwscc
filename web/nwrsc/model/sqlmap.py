...
'GETCLASSGROUPMAPPING':'select classcode,rungroup from rungroups where eventid=:h1',
...
'INSERTBLANKCHALLENGEROUND':'insert into challengerounds (challengeid,round,car1id,car2id) values (:h1,:h2,:h3,:h4)',
...
'INSERTRUN':'insert into runs (carid,eventid,course,run,cones,gates,status,rorder,norder,reaction,sixty,seg1,seg2,seg3,seg4,seg5,raw,net) values (:h1,:h2,:h3,:h4,:h5,:h6,:h7,:h8,:h9,:h10,:h11,:h12,:h13,:h14,:h15,:h16,:h17,:h18)',
...
'UPDATECHALLENGEROUND':'update challengerounds set challengeid=:h1,round=:h2,car1id=:h3,car1dial=:h4,car1result=:h5,car1newdial=:h6,car2id=:h7,car2dial=:h8,car2result=:h9,car2newdial=:h10 where id=:h11',
...
'UPDATEEVENTS':'update events set ispro=:h1,courses=:h2,runs=:h3,segments=:h4,password=:h5,name=:h6,date=:h7,location=:h8,sponsor=:h9,host=:h10,designer=:h11,regopened=:h12,regclosed=:h13,perlimit=:h14,totlimit=:h15,cost=:h16,paypal=:h17,snail=:h18,notes=:h19 where id=:h20',
'UPDATERUN':'update runs set carid=:h1,eventid=:h2,course=:h3,run=:h4,cones=:h5,gates=:h6,status=:h7,rorder=:h8,norder=:h9,reaction=:h10,sixty=:h11,seg1=:h12,seg2=:h13,seg3=:h14,seg4=:h15,seg5=:h16,raw=:h17,net=:h18 where id=:h19',
}
