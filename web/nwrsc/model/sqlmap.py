...
'UPDATEEVENTS':'update events set ispro=:h1,courses=:h2,runs=:h3,countedruns=:h4,segments=:h5,password=:h6,name=:h7,date=:h8,location=:h9,sponsor=:h10,host=:h11,designer=:h12,regopened=:h13,regclosed=:h14,perlimit=:h15,totlimit=:h16,cost=:h17,paypal=:h18,snail=:h19,notes=:h20 where id=:h21',
