...
'GETEVENTRESULTSBYCLASS':'select d.firstname,d.lastname,c.id as carid,c.indexcode,r.position,r.courses,r.sum,r.diff,r.diffpoints,r.pospoints,r.updated from eventresults as r, cars as c, drivers as d where r.carid=c.id and c.driverid=d.id and r.classcode=:h1 and r.eventid=:h2 order by position',
