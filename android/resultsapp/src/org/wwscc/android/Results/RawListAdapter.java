 ...
 */
public class RawListAdapter extends JSONArrayAdapter
{
	private static final int[] labels = new int[] { R.id.position, R.id.name, R.id.classcode, R.id.sum };
	...
	{
		return inflater.inflate(R.layout.line_rawresults, parent, false);
	}
