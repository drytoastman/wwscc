...
'GETRUNORDERENTRANTS':'select d.firstname,d.lastname,c.*,reg.paid from registered as reg, runorder as r, cars as c, drivers as d where reg.carid=c.id and reg.eventid=r.eventid and r.carid=c.id AND c.driverid=d.id and r.eventid=:h1 AND r.course=:h2 AND r.rungroup=:h3 order by r.row',
...
'LOADENTRANT':'select d.firstname,d.lastname,c.*,r.paid from registered as r, cars as c, drivers as d where r.carid=c.id and c.driverid=d.id and c.id=:h1 and r.eventid=:h2 ',
