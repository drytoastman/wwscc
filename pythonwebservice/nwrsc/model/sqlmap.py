...
'GETEVENTRESULTSBYCLASS':'select d.firstname,d.lastname,c.indexcode,r.* from eventresults as r, cars as c, drivers as d where r.carid=c.id and c.driverid=d.id and r.classcode=:h1 and r.eventid=:h2 order by position',
